...
public class UIDoctorMenu {
    ...
    public static ArrayList<Doctor> doctorsAvailablesApointments = new ArrayList<>();
    ...
    private static void showAddAvailableAppointmentsMenu(){
        ...
        do {
            ...
            if(response > 0 && response < 4){
                ...
                System.out.println("Insrert the date available: [dd/mm/yyyy]");
    ...
    private static void checkDoctorAvailableAppointment(Doctor doctor){
        ...
        && !doctorsAvailablesApointments.contains(doctor)){
            doctorsAvailablesApointments.add(doctor);
        }
    }
}
